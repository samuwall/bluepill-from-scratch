...
#define AFIO_EXTICR3_EXTI8_Shft     0U
#define AFIO_EXTICR3_EXTI9_Shft     4U
#define AFIO_EXTICR3_EXTI10_Shft    8U
#define AFIO_EXTICR4_EXTI12_Shft    0U

#define USB_EPR_EA_Shft             0U
#define USB_EPR_STAT_TX_Shft        4U
#define USB_EPR_DTOG_TX_Shft        6U
#define USB_EPR_CTR_TX_Shft         7U
#define USB_EPR_EP_KIND_Shft        8U
#define USB_EPR_EP_TYPE_Shft        9U
#define USB_EPR_SETUP_Shft          11U
#define USB_EPR_STAT_RX_Shft        12U
#define USB_EPR_DTOG_RX_Shft        14U
#define USB_EPR_CTR_RX_Shft         15U
#define USB_ISTR_EP_ID_Shft         0U
#define USB_DADDR_ADDR_Shft         0U
...
#define AFIO_EXTICR3_EXTI8_Msk      (0b1111 << AFIO_EXTICR3_EXTI8_Shft)
#define AFIO_EXTICR3_EXTI9_Msk      (0b1111 << AFIO_EXTICR3_EXTI9_Shft)
#define AFIO_EXTICR3_EXTI10_Msk     (0b1111 << AFIO_EXTICR3_EXTI10_Shft)
#define AFIO_EXTICR4_EXTI12_Msk     (0b1111 << AFIO_EXTICR4_EXTI12_Shft)

#define USB_DADDR_ADDR_Msk          (0b1111111 << USB_DADDR_ADDR_Shft)
#define USB_EPR_EA_Msk              (0b1111 << USB_EPR_EA_Shft)
#define USB_EPR_STAT_TX_Msk         (0b11   << USB_EPR_STAT_TX_Shft)
#define USB_EPR_DTOG_TX_Msk         (0b1    << USB_EPR_DTOG_TX_Shft)
#define USB_EPR_CTR_TX_Msk          (0b1    << USB_EPR_CTR_TX_Shft)
#define USB_EPR_EP_KIND_Msk         (0b1    << USB_EPR_EP_KIND_Shft)
#define USB_EPR_EP_TYPE_Msk         (0b11   << USB_EPR_EP_TYPE_Shft)
#define USB_EPR_SETUP_Msk           (0b1    << USB_EPR_SETUP_Shft)
#define USB_EPR_STAT_RX_Msk         (0b11   << USB_EPR_STAT_RX_Shft)
#define USB_EPR_DTOG_RX_Msk         (0b1    << USB_EPR_DTOG_RX_Shft)
#define USB_EPR_CTR_RX_Msk          (0b1    << USB_EPR_CTR_RX_Shft)
#define USB_EPR_NONTOGGLE_Msk       (USB_EPR_CTR_RX_Msk | \
                                    USB_EPR_SETUP_Msk   | \
                                    USB_EPR_EP_TYPE_Msk | \
                                    USB_EPR_EP_KIND_Msk | \
                                    USB_EPR_CTR_TX_Msk  | \
                                    USB_EPR_EA_Msk)
#define USB_EPR_RC_W0_Msk           (USB_EPR_CTR_TX_Msk | USB_EPR_CTR_RX_Msk)
#define USB_ISTR_EP_ID_Msk          (0b1111 << USB_ISTR_EP_ID_Shft)
...
#define AFIO_EXTICR3_EXTI8_PA8      (0b0000 << AFIO_EXTICR3_EXTI8_Shft)
#define AFIO_EXTICR3_EXTI9_PA9      (0b0000 << AFIO_EXTICR3_EXTI9_Shft)
#define AFIO_EXTICR3_EXTI10_PA10    (0b0000 << AFIO_EXTICR3_EXTI10_Shft)

#define AFIO_EXTICR4_EXTI12_PB12    (0b0001 << AFIO_EXTICR4_EXTI12_Shft)
...
#define USB_EPR_EP_TYPE_BULK        (0b00 << USB_EPR_EP_TYPE_Shft)
#define USB_EPR_EP_TYPE_CONTROL     (0b01 << USB_EPR_EP_TYPE_Shft)
#define USB_EPR_EP_TYPE_ISO         (0b10 << USB_EPR_EP_TYPE_Shft)
#define USB_EPR_EP_TYPE_INTERRUPT   (0b11 << USB_EPR_EP_TYPE_Shft)
#define USB_EPR_STAT_TX_DISABLED    (0b00 << USB_EPR_STAT_TX_Shft)
#define USB_EPR_STAT_TX_STALL       (0b01 << USB_EPR_STAT_TX_Shft)
#define USB_EPR_STAT_TX_NAK         (0b10 << USB_EPR_STAT_TX_Shft)
#define USB_EPR_STAT_TX_VALID       (0b11 << USB_EPR_STAT_TX_Shft)
#define USB_EPR_STAT_RX_DISABLED    (0b00 << USB_EPR_STAT_RX_Shft)
#define USB_EPR_STAT_RX_STALL       (0b01 << USB_EPR_STAT_RX_Shft)
#define USB_EPR_STAT_RX_NAK         (0b10 << USB_EPR_STAT_RX_Shft)
#define USB_EPR_STAT_RX_VALID       (0b11 << USB_EPR_STAT_RX_Shft)

#define USB_CNTR_FRES_              (1 << 0)
#define USB_CNTR_PDWN_              (1 << 1)
#define USB_CNTR_LP_MODE_           (1 << 2)
#define USB_CNTR_FSUSP_             (1 << 3)
#define USB_CNTR_RESUME_            (1 << 4)
#define USB_CNTR_ESOFM_             (1 << 8)
#define USB_CNTR_SOFM_              (1 << 9)
#define USB_CNTR_RESETM_            (1 << 10)
#define USB_CNTR_SUSPM_             (1 << 11)
#define USB_CNTR_WKUPM_             (1 << 12)
#define USB_CNTR_ERRM_              (1 << 13)
#define USB_CNTR_PMAOVRM_           (1 << 14)
#define USB_CNTR_CTRM_              (1 << 15)

#define USB_ISTR_DIR_               (1 << 4)
#define USB_ISTR_ESOF_              (1 << 8)
#define USB_ISTR_SOF_               (1 << 9)
#define USB_ISTR_RESET_             (1 << 10)
#define USB_ISTR_SUSP_              (1 << 11)
#define USB_ISTR_WKUP_              (1 << 12)
#define USB_ISTR_ERR_               (1 << 13)
#define USB_ISTR_PMAOVR_            (1 << 14)
#define USB_ISTR_CTR_               (1 << 15)

#define USB_FNR_LCK_                (1 << 13)

#define USB_DADDR_EF_               (1 << 7)    /* 1 = enable function: "This bit is set by the software to enable the USB device" */

/* ---  TIM ---------------------------------------------------------------- */

#define TIM_CR1_CEN_                (1 << 0)

#define TIM_EGR_UG_                 (1 << 0)
